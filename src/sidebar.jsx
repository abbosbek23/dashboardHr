        ...
        <div className={'sidebar'}>
          ...
          <Box>
            ...
            <ul ref={dashboardRef} style={{ marginTop:"20px", transition: 'height 0.5s'}}>
              ...
              <li onClick={() => {navigate('filiallar'); handleButtonClick('filiallar')}} style={{marginBlock:"10px",paddingBlock:"15px",backgroundColor: activeButton === 'filiallar' ? "#00DEA3" : "white",color:activeButton === 'filiallar' ? "#FFF":"#000",cursor:"pointer",borderRadius:"12px"}}>Filiallar Overview</li>
